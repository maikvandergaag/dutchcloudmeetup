...
* [Configuration](#configuration)
  ...
  * [Landing page](#landing-page)
    ...
    * [See more](#see-more)
    * [Clients](#clients)
    * [Current And Past Events](#recent-posts)
    * [Footer](#footer)
  * [Meta tags](#meta-tags)
* [Usage](#usage)
...
The Current And Past Events sections shows the four latest published blog posts, with their featured image and an optional summary. It defaults to show Current And Past Events from all [main sections](https://gohugo.io/functions/where/#mainsections). This is either the section with the most posts or can be set explicitly in the configuration file (see linked docs).
...
Current And Past Events use `.Summary` property and by default, Hugo automatically takes the first 70 words of your content as its summary and stores it into the `.Summary` page variable for use in your templates. You may customize the summary length by setting summaryLength in your site configuration.

#### Footer

In the footer there are three blocks customizables: `About us`, `Current And Past Events` and `contact`. Each block can be set via parameters.
...
Current And Past Events block can be enabled or disabled (hidden).
